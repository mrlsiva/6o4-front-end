...
export class CaseHistoryComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    jQuery('#selectInspector_s').select2({});
    jQuery('#selectSupervisor_s').select2({});
    jQuery('#selectSupervisor').select2({});
  ...
  assignAdvancedSearchModel() {
    ...
    this._advancedSearchViewModel.supervisorId = jQuery('#selectSupervisor').val();
    let supervisorNameList: string = '';
    this._advancedSearchViewModel.supervisorId.forEach((v: any) => {
      supervisorNameList += this._supervisorList.find(c => c.id == v).name + ',';
    });
    if (supervisorNameList.length > 0) {
      this.filterDataArray.push({ key: "Supervisor", value: supervisorNameList.slice(0, (supervisorNameList.length - 1)) });
  ...
  advancedSearch() {
    ...
    jQuery('#selectStatus').select2({});
    jQuery('#selectProgram').select2({});
    jQuery('#selectSource').select2({});
    jQuery('#selectInspector').select2({});
    jQuery('#selectViolationType').select2({});
    jQuery('#selectCDBG').select2({});
    jQuery('#selectStreet').select2({});
    jQuery('#selectCasePriority').select2({});
    jQuery('#selectSupervisor').select2({});
  ...
  simpleSearch() {
    ...
    jQuery('#btnCompressedSearch').addClass('hide');
    jQuery('#btnAdvancedSearch').removeClass('hide');
    jQuery('#selectProgram_s').select2({});
    jQuery('#selectStatus_s').select2({});
    jQuery('#selectstreet_s').select2({});
    jQuery('#selectInspector_s').select2({});
    jQuery('#selectSupervisor_s').select2({});
    console.log('Simple Search Boolean:', this.isSimpleSearch);
  }
