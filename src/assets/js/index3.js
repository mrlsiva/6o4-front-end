   ...
   // chart 6
    var ctx = document.getElementById("chart6").getContext('2d');
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['Multi Housing', 'General', 'CDBG', 'Tobacco', 'Vacant Building', 'Blight Buster', 'Animal Services', 'Vacant Building'],
 ...
 var ctx = document.getElementById('chart7').getContext('2d');
  ...
  var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 300);
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: ['Multi Housing', 'General', 'CDBG', 'Tobacco', 'Vacant Building', 'Blight Buster', 'Animal Services'],
